#!/bin/bash
# Eval-only structural block cutoff for C2 final.
#
# This is the cheap gate before retraining: block learned CS-DNO transfer-kernel
# corrections above K_CUT at inference, with no runtime Gxi limiter.

set -euo pipefail
cd /home/johnma/dno-fno

K_CUT="${1:-32}"
RUN_DIR="${2:-outputs/c2_stage_match_gain_from_v85b_20260707_053707}"
TRUTH_CACHE="${3:-outputs/cs_dno_w512b8_l256_v9_h100x2_20260703_035745/eval_2x2v3_off_20260706_070633}"

STAMP=$(date +%Y%m%d_%H%M%S)
OUT_DIR="$RUN_DIR/eval_blockkcut${K_CUT}_$STAMP"
...
COMMON_ARGS=(
    ...
    --cs_block_k_cut "$K_CUT"
)

echo "===== C2 block-k-cut eval ====="
echo "k_cut:       $K_CUT"

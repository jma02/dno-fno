"""Focused safety and state-transition tests for the corpus watchdog."""
...
from scripts import watch_paper_corpus_workers as watchdog_module
from scripts.watch_paper_corpus_workers import (
    ExactWorkerMatcher,
    FileToken,
    HeartbeatToken,
    MatchedWorker,
...
class CorpusWorkerWatchdogTest(unittest.TestCase):
    ...
    def _canonical_final_fixture(self) -> tuple[Path, dict[str, object]]:
        from scripts import run_paper_corpus_quota as quota_module
        ...
        for plan in plans:
            ...
            if plan.family == "stokes":
                ...
                configuration["population_support"] = (
                    quota_module._benjamin_feir_population_support_record()
                )
    ...
    def test_source_summary_requires_exact_release_configuration(self) -> None:
        ...
        mutations = (
            ...
            ("dependency", "tanaka"),
            ("source_map", "tanaka"),
            ("population_support", "benjamin_feir"),
        ...
        for mutation, family in mutations:
            with self.subTest(mutation=mutation):
                ...
                elif mutation == "population_support":
                    configuration["population_support"]["schema"] = "forged"
                else:

...
SESSION=${SESSION:-dno_paper_corpus_postcompletion}
LAUNCH_LOG=${LAUNCH_LOG:-$ROOT/outputs/paper_corpus_postcompletion_launcher.log}
RUNNER=$ROOT/scripts/run_paper_corpus_postcompletion.py

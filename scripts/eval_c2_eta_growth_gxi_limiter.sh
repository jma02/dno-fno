#!/bin/bash
# Eval C2 final with temporal eta-growth-gated Gxi high-band limiter.
...
OUT_DIR="$RUN_DIR/eval_eta_growth_gxi_limiter_$STAMP"
...
COMMON_ARGS=(
    ...
    --eta_growth_gxi_limiter
    --eta_growth_gxi_limiter_k_lo 64
    --eta_growth_gxi_limiter_k_hi 128
    --eta_growth_gxi_limiter_abs_floor 1e-4
    --eta_growth_gxi_limiter_growth_factor 100
    --gxi_highband_k_cut 32
    --gxi_highband_r_max 1e-2
    --gxi_highband_abs_floor 5
)

echo "===== C2 eta-growth-gated Gxi limiter eval ====="
...
echo
echo "===== C2 eta-growth-gated Gxi limiter eval DONE ====="

"""Cross-check the frozen paper-dataset layout at every release boundary."""
...
from scripts import audit_paper_dataset_training_handoff as handoff  # noqa: E402
from scripts import bind_completed_stokes_revision2_audit as stokes_audit  # noqa: E402
from scripts import run_paper_dataset_postcompletion as postcompletion  # noqa: E402
from scripts import watch_paper_dataset_workers as watchdog  # noqa: E402
...
VIEW_BUILDER: Final = ROOT / "scripts/build_literature_aligned_paper_dataset_views.sh"
EXECUTABLE_ENTRYPOINTS: Final = (
    JONSWAP_LAUNCHER,
    TANAKA_LAUNCHER,
    ROOT / "scripts/launch_tanaka_after_revision4_jonswap.sh",
    VIEW_BUILDER,
    ROOT / "scripts/launch_paper_dataset_postcompletion.sh",
)
...
AUDIT_ROOTS: Final = {
    "stokes": stokes_audit.DEFAULT_DATASET_ROOT.resolve(),
    "tanaka": tanaka_audit.DEFAULT_DATASET_ROOT.resolve(),
    "benjamin_feir": bf_audit.DEFAULT_DATASET_ROOT.resolve(),
    "jonswap_tma": jonswap_audit.DEFAULT_DATASET_ROOT.resolve(),
}
...
class PaperDatasetReleaseLayoutContractTest(unittest.TestCase):
    ...
    def test_builder_auditors_and_postcompletion_share_release_contract(self) -> None:
        ...
        production_revisions = {
            family: paper_dataset_revision_id(

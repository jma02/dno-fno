...
PAPER_CORPUS_REVISION_BY_FAMILY: Final[Mapping[PhysicalFamilyId, int]] = (
    MappingProxyType(
        {
            PhysicalFamilyId.STOKES: 2,
            PhysicalFamilyId.TANAKA: 3,
            PhysicalFamilyId.BENJAMIN_FEIR: 4,
            PhysicalFamilyId.JONSWAP_TMA: 3,
        }
    )
)


def paper_corpus_revision_id(family_id: PhysicalFamilyId) -> int:
    ...
    return PAPER_CORPUS_REVISION_BY_FAMILY[family_id]

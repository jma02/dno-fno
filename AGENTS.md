...
- Keep bookkeeping minimal. Track values only when computation, recovery, or an intentional output needs them; avoid redundant counters and temporary metric payloads.

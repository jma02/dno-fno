...
each quantity is divided by its training-corpus absolute maximum:
\[
\hat\eta = \eta / s_\eta, \qquad
\hat\xi  = \xi  / s_\xi, \qquad
\widehat{\Gop\xi} = \Gop\xi / s_g,
\]
with $s_\xi = 0.14096$ and $s_g = 0.76948$ for the v3 corpus (recorded in
...
seeded global permutation: 4{,}795{,}193 train / 599{,}398 val. The v4 corpus in

...
and the **corpus** is the collection of accepted cases presented to the
...
The [shape-stress figure](../outputs/paper_corpus_shape_stress_20260724/paper_corpus_shape_stress.png)
shows:
...
The [finite-Stokes boundary figure](../outputs/paper_corpus_shape_stress_20260724/finite_stokes_boundary_panel.png)
...
`outputs/paper_corpus_shape_stress_20260724/shape_stress_metrics.json`.
...
[replacement Ursell figure](../outputs/paper_corpus_shape_stress_20260724/finite_stokes_ursell_panel.png)
...
regenerated-corpus model. The paper does not infer continuum-DNO accuracy
...
JAX_PLATFORMS=cpu JAX_ENABLE_X64=True CUDA_VISIBLE_DEVICES='' \
  uv run python -m solver.gen_data.generate_stokes_dataset \
    --output outputs/paper_corpus_stokes_ursell_smoke_20260725.npz \
    --regime shallow --target_samples 16 --batch_size 16 --seed 42 \
    --overwrite

JAX_PLATFORMS=cpu JAX_ENABLE_X64=True CUDA_VISIBLE_DEVICES='' \
  uv run python -m solver.gen_data.generate_stokes_dataset \
    --output outputs/paper_corpus_stokes_deep_smoke_20260725.npz \
...
JAX_PLATFORMS=cpu JAX_ENABLE_X64=True CUDA_VISIBLE_DEVICES='' \
  uv run python scripts/plot_paper_corpus_shape_stress.py

...
(\texttt{playground/diagnostics/literature\_review.md}) for full
...
\begin{itemize}[leftmargin=1.3em,itemsep=1pt]
  \item Data audit: \texttt{playground/diagnostics/data\_audit\_report.md},
        \texttt{data\_audit.json}, \texttt{audit\_data.py}.
  \item Rollout forensics: \texttt{playground/diagnostics/
        rollout\_forensics\_report.md}, \texttt{rollout\_forensics.json},
        and the analysis scripts \texttt{rollout\_forensics*.py}.
  \item Literature scan:
        \texttt{playground/diagnostics/literature\_review.md}.
  \item Per-regime error-vs-wavenumber plots:
        \texttt{outputs/error\_vs\_k/*\_err\_vs\_k.png}; site builder at
        \texttt{playground/build\_paper\_dashboard.py};
        live at \href{https://stunning-cocada-db3a7d.netlify.app}{stunning-cocada-db3a7d.netlify.app}.

...
sequence.  A successful proposal stores its realized mode, amplitude, depth,
phase, branch, and category.
...
redraw allowance is exhausted, the sampler returns no state and the batch
commits a zero-row out-of-support rejection; generation then fills the remaining

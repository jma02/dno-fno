...
> **Historical population laws.**  This parameter-only smoke predates the
> current family-local revision tuple (Stokes 2, Tanaka 3, Benjamin--Feir 4,
> JONSWAP/TMA 4).  In particular, it used the old four-category Tanaka law,
> the old Benjamin--Feir law with a sampled common sideband phase and
> \(\rho\leq0.20\), and random-sea revision 1 with the former shallow bound
> \(k_pH_s/2\leq0.15\).  Current JONSWAP/TMA revision 4 instead requires
> \(k_pH_s/2\leq0.08\) in every depth stratum and uses its declared relative-
> frequency interval.  The counts, formulas, and plots below describe only
> the archived smoke and must not be used as the current population contract.
...
[summary.json](../outputs/paper_dataset_population_smoke_500k_20260725/summary.json).
...
- [Exact allocations and support overview](../outputs/paper_dataset_population_smoke_500k_20260725/figures/overview_counts_support.png)
- [Stokes parameter population](../outputs/paper_dataset_population_smoke_500k_20260725/figures/stokes_population.png)
- [Tanaka parameter population](../outputs/paper_dataset_population_smoke_500k_20260725/figures/tanaka_population.png)
- [Benjamin--Feir parameter population](../outputs/paper_dataset_population_smoke_500k_20260725/figures/benjamin_feir_population.png)
- [JONSWAP/TMA parameter population](../outputs/paper_dataset_population_smoke_500k_20260725/figures/jonswap_tma_population.png)
- [Stokes selected-field gallery](../outputs/paper_dataset_population_smoke_500k_20260725/figures/stokes_field_gallery.png)
- [Tanaka selected-field gallery](../outputs/paper_dataset_population_smoke_500k_20260725/figures/tanaka_field_gallery.png)
- [Benjamin--Feir selected-field gallery](../outputs/paper_dataset_population_smoke_500k_20260725/figures/benjamin_feir_field_gallery.png)
- [JONSWAP/TMA selected-field gallery](../outputs/paper_dataset_population_smoke_500k_20260725/figures/jonswap_tma_field_gallery.png)
- [Stokes cell atlas](../outputs/paper_dataset_population_smoke_500k_20260725/figures/stokes_cell_atlas.png)
- [Tanaka cell atlas](../outputs/paper_dataset_population_smoke_500k_20260725/figures/tanaka_cell_atlas.png)
- [Benjamin--Feir cell atlas](../outputs/paper_dataset_population_smoke_500k_20260725/figures/benjamin_feir_cell_atlas.png)
- [JONSWAP/TMA cell atlas](../outputs/paper_dataset_population_smoke_500k_20260725/figures/jonswap_tma_cell_atlas.png)
- [Machine-readable figure definitions and selected-case records](../outputs/paper_dataset_population_smoke_500k_20260725/figures/plot_summary.json)
...
numerical yield of the final trajectory dataset.
